...
namespace MasterData.Repositories.MySql
{
    public class AreaDb
    {
        ...
        {
            string sqlQuery = "INSERT into mt_area (id, name) VALUES (@id, @name)";
        ...
        {
            string sqlQuery = "SELECT id, name from mt_area";
        ...
        {
            string sqlQuery = "SELECT id, name from mt_area where id = @id";
